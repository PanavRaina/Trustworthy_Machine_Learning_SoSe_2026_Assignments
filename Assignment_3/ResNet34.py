...
# backbone arechitecture
ARCH = "resnet34"

# path
DATA_PATH  = "/home/atml_team038/TASK_3/train.npz"
MODELS_DIR = "/home/atml_team038/TASK_3/main_2_models"
BEST_OUT   = f"/home/atml_team038/TASK_3/main_2_models/model_{ARCH}.pt"
...
# Validation: PGD-20 at eps=8/255 
VAL_EPS   = 8 / 255.0
VAL_ALPHA = 2 / 255.0
VAL_STEPS = 20
...
scheduler = optim.lr_scheduler.OneCycleLR(optimizer, max_lr=LR_MAX, steps_per_epoch=len(train_loader),epochs=EPOCHS, pct_start=0.05, anneal_strategy="cos")
...
for epoch in range(1, EPOCHS + 1):
    ...
    print(f"[{ARCH}] epoch {epoch:3d}/{EPOCHS} "f"loss={run_loss/total:.4f}  acc={correct/total:.3f}", flush=True)

    #checking validation epoch every 5 epochs to prevent overfitting
    if epoch % 5 == 0 or epoch == EPOCHS:
        ...
        print(f"validation scores: epoch {epoch}: clean={clean_acc:.4f}  "f"robust={rob_acc:.4f}  score={score:.4f}", flush=True)
